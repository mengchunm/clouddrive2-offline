...
import { GM_registerMenuCommand, unsafeWindow } from "vite-plugin-monkey/dist/client";
...
(function main() {
    ...
    unsafeWindow.addEventListener("cd2-play-video", handlePlayVideo as EventListener);
