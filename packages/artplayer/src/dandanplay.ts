...
import { GM_xmlhttpRequest, GM_getValue, GM_setValue } from "vite-plugin-monkey/dist/client";
 ...
 * 通过关键词搜索剧集
 */
export async function searchEpisodes(keyword: string): Promise<SearchEpisodeResult> {
 ...
 */
export async function fetchComments(episodeId: number, withRelated = true): Promise<CommentResponse> {
